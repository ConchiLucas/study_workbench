...
import (
	...
	"github.com/conchi/go-react-template/server/model/common"
	"github.com/conchi/go-react-template/server/model/common/request"
	...
	systemRes "github.com/conchi/go-react-template/server/model/system/response"
...
func (b *BaseApi) Login(c *gin.Context) {
	...
	if !databaseReady() {
		response.FailWithMessage("数据库尚未初始化，请先完成系统初始化", c)
		return
	}
